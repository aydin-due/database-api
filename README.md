...
Endpoint GET que regres el explorer al enviar un ID por query params
...
Endpoint PUT, en el cuál recibirE el ID del explorer a actualizar, y en el cuerpo del request el campo mission a actualizar
